...
public class QuotaFragment extends Fragment {
    ...
    protected void initView(){
        quotaList = (ListView)getActivity().findViewById(R.id.quota_list);

        quotaList.setAdapter(new MyAdapter(getActivity(),init()));
        quotaList.setOnItemClickListener(new MyListClick(getActivity()));
    }
