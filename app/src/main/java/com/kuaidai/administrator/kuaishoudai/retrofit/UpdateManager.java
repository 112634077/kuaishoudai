package com.kuaidai.administrator.kuaishoudai.retrofit;
...
public class UpdateManager {
    ...
    private void showNoticeDialog() {
        ...
        //更新
        builder.setPositiveButton(R.string.soft_updating, new OnClickListener() {
    ...
    public boolean isUpdate() {
        ...
        Log.d("UpdateManager.java",versionCode+"");
...
//        System.out.println(inStream);
        ...
        try {
            String path = "http://192.168.43.253/version.xml";
    ...
    private int getVersionCode(Context context) {
        ...
        try {
            versionCode = context.getPackageManager().getPackageInfo(
                    "com.kuaidai.administrator.kuaishoudai", 0).versionCode;
