...
public class RateFragment extends Fragment {
    ...
    protected void initView(){
        rateList = (ListView)getActivity().findViewById(R.id.rate_list);

        rateList.setAdapter(new MyAdapter(getActivity(),init()));
        rateList.setOnItemClickListener(new MyListClick(getActivity()));
    }
